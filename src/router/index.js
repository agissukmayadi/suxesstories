...
const router = createRouter({
    ...
    routes: [{
        ...
        },
        {
            ...
            component: () =>
                import ("../views/TalentDashboard.vue"),
            meta: {
                requiresAuth: true,
                requiresRole: ["talent"],
            },
